...
#     Mall = StringProperty("Missing data")
...
class TaxiMDDialog(BaseDialog):
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class TaxiStandMDDialog(BaseDialog):
    TaxiCode = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    Bfa = StringProperty("Missing data")
    Ownership = StringProperty("Missing data")
    Type = StringProperty("Missing data")
    Name = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')
...
class BusServiceMDDialog(BaseDialog):
    ServiceNo = StringProperty("Missing data")
    Operator = StringProperty("Missing data")
    Direction = StringProperty("Missing data")
    Category = StringProperty("Missing data")
    OriginCode = StringProperty("Missing data")
    DestinationCode = StringProperty("Missing data")
    AM_Peak_Freq = StringProperty("Missing data")
    AM_Offpeak_Freq = StringProperty("Missing data")
    PM_Peak_Freq = StringProperty("Missing data")
    PM_Offpeak_Freq = StringProperty("Missing data")
    LoopDesc = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class BusRouteMDDialog(BaseDialog):
    ServiceNo = StringProperty("Missing data")
    Operator = StringProperty("Missing data")
    Direction = StringProperty("Missing data")
    StopSequence = StringProperty("Missing data")
    BusStopCode = StringProperty("Missing data")
    Distance = StringProperty("Missing data")
    WD_FirstBus = StringProperty("Missing data")
    WD_LastBus = StringProperty("Missing data")
    SAT_FirstBus = StringProperty("Missing data")
    SAT_LastBus = StringProperty("Missing data")
    SUN_FirstBus = StringProperty("Missing data")
    SUN_LastBus = StringProperty("Missing data")
    BusStopDescription = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    BusArriving = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class CarParkMDDialog(BaseDialog):
    CarParkID = StringProperty("Missing data")
    Area = StringProperty("Missing data")
    Development = StringProperty("Missing data")
    Location = StringProperty("Missing data")
    AvailableLots = StringProperty("Missing data")
    LotType = StringProperty("Missing data")
    Agency = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class BicycleParkingMDDialog(BaseDialog):
    Description = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    RackType = StringProperty("Missing data")
    RackCount = StringProperty("Missing data")
    ShelterIndicator = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class MrtMDDialog(BaseDialog):
    MRT = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    Road_name = StringProperty("Missing data")
    Building = StringProperty("Missing data")
    Address = StringProperty("Missing data")
    Postal = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')

class LrtMDDialog(BaseDialog):
    LRT = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    Road_name = StringProperty("Missing data")
    Building = StringProperty("Missing data")
...
class IncidentsMDDialog(BaseDialog):
    Type = StringProperty("Missing data")
    Latitude = StringProperty("Missing data")
    Longitude = StringProperty("Missing data")
    Message = StringProperty("Missing data")
    background = StringProperty(f'{images_path}ios_bg_mod.png')
